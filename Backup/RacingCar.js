...
window.addEventListener('DOMContentLoaded', function () {
    ...
    var createScene = function () {
        ...
        //         camera.target = newMeshes[0];
        //         console.log(newMeshes[0]);
        //         newMeshes[0].position = new BABYLON.Vector3(0, 0.25, 0);
        //     });
        // var car = BABYLON.SceneLoader.ImportMesh("", "", "Models/Cars/Car1/B/Car1.babylon", scene,
        //     function (newMeshes) {
        //         camera.target = newMeshes[0];
        //         newMeshes[0].position = new BABYLON.Vector3(2, 0.05, 0);
        //     });
        ...
        var city = BABYLON.SceneLoader.ImportMesh("", "", "Models/Environments/Env7/B/Env7.babylon", scene,
            function (newMeshes) {
                camera.target = newMeshes[0];
                console.log(newMeshes[0]);
                newMeshes[0].scaling = new BABYLON.Vector3(70, 70,70);
                //  newMeshes[0].position = new BABYLON.Vector3(-14,-2.2,-40);
                newMeshes[0].position = new BABYLON.Vector3(110, -0.3, -45);
            });
        var groundSize = 1000;
        //  car.position.y=1.5;
